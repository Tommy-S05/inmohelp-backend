...
class UsersRelationManager extends RelationManager
{
    ...
    {
        return auth()->user()->hasRole(['super_admin']) || auth()->user()->hasPermissionTo('attach_role:User', 'web');
    }

    protected function canDetach(Model $record): bool
    {
        return auth()->user()->hasRole(['super_admin']) || auth()->user()->hasPermissionTo('detach_role:User', 'web');
    }

    protected function canDetachAny(): bool
    {
        return auth()->user()->hasRole(['super_admin']) || auth()->user()->hasPermissionTo('detach_any_role:User', 'web');
    }
